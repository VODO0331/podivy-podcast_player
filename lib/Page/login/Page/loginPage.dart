...
import 'package:podivy/service/auth/authErrorException.dart';
...
import 'package:podivy/util/compressImg.dart';
      ...
      listener: (context, state) async {
        if (state is AuthStateLoggedOut) {
          ...
          if (exception != null) {
            ...
            } else if (state.exception is ChannelWorngAuthException) {
              await showErrorDialog(
                context,
                '輸入多次，請稍後再試',
              );
